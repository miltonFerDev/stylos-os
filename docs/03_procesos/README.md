...
Documentar los procesos operativos del negocio: cómo se hacen las cosas hoy, quién las hace, con qué frecuencia, y qué datos o documentos intervienen.
...
| Pago de sueldos | PENDIENTE | PENDIENTE |
| Gestión de sponsors | PENDIENTE | PENDIENTE |
| Gestión de promociones | PENDIENTE | PENDIENTE |
| Análisis semanal | PENDIENTE | PENDIENTE |
| Análisis mensual | PENDIENTE | PENDIENTE |

## Convenciones

- Cada proceso se documenta en un archivo Markdown separado dentro de esta carpeta.
